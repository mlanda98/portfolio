      ...
      <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto text-left">
        {
          ...
          <div className="bg-white rounded-xl shadow-md p-6 space-y-4 md:col-span-2">
            ...
            <p className="text-gray-600">
              Designed and developed a high-performing local business website
              for a pool remodeling and replastering company. Focused on
              improving local search visibility and converting organic traffic
              into qualified leads through SEO-driven structure and UX
              optimization.
            </p>

            <ul className="text-gray-600 list-disc pl-5 space-y-1">
              <li>
                Built and optimized city-specific landing pages targeting
                high-intent local keywords (Tracy, Sacramento, and surrounding
                areas)
              </li>
              <li>
                Implemented on-page SEO best practices including meta titles,
                descriptions, headers, and internal linking strategy
              </li>
              <li>
                Developed a conversion-focused “Get a Quote” page to generate
                inbound leads for the business
              </li>
              <li>
                Improved site structure, navigation flow, and mobile
                responsiveness to enhance UX and search performance
              </li>
              <li>
                Deployed on Netlify with a custom domain and ongoing iterative
                SEO improvements
              </li>
            </ul>
